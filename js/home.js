    document.addEventListener('DOMContentLoaded', function () {
      ...
      var CS_I18N = {
        es: {
          ...
          'precios-urgency': { t: 'Precios de este trimestre. Tomamos 5 proyectos nuevos al mes.' },
          ...
          'launch-features': { h: '<li><strong>Identidad visual básica incluida</strong> — logo, paleta, tipografía</li><li>Una página de alto impacto con 4 secciones (hero, servicios, sobre ti, contacto)</li><li>Diseño responsive — celular y computadora</li><li>SEO básico configurado desde el inicio</li><li><strong>Listo para búsquedas con IA</strong> — schema y llms.txt para que ChatGPT, Gemini y Perplexity puedan leerte</li><li>Formulario de contacto incluido</li><li>Dominio <strong>.com</strong> incluido el primer año (o conectamos el tuyo si ya lo tienes)</li><li>Cambios de contenido a través de Cero Studio</li>' },
          'launch-note': { t: 'Ideal para: restaurantes, consultorios, salones, servicios locales.' },
          'launch-after': { h: 'Después del lanzamiento: Mantenimiento Launch $1,000 MXN/mes, sin contrato anual → <a href="/servicios/mantenimiento/" data-href-es="/servicios/mantenimiento/" data-href-en="/en/services/web-maintenance/">ver planes</a>' },
          'launch-cta': { t: 'Quiero empezar →' },
          'pro-badge': { t: 'Más solicitado' },
          'pro-delivery': { t: 'pago único · entrega 21 días hábiles' },
          'pro-features': { h: '<li><strong>Identidad profesional incluida</strong> — logo, paleta, tipografía + guidelines mini</li><li>4 a 6 páginas diseñadas desde cero para tu marca</li><li>Tú editas el contenido — sin depender de nosotros</li><li>Blog incluido para posicionarte como experto</li><li>Animaciones y microinteracciones a medida</li><li>SEO avanzado + Google Search Console</li><li><strong>Optimizado para búsquedas con IA</strong> — schema, llms.txt y contenido citable en cada página, para que ChatGPT, Gemini y Perplexity te recomienden</li><li>Google Analytics + Tag Manager configurados</li><li>Botón de WhatsApp integrado</li><li>Dominio <strong>.com</strong> incluido el primer año (o conectamos el tuyo si ya lo tienes)</li><li>Responsive — celular, tablet y escritorio</li><li>Formulario de contacto profesional</li>' },
          'pro-note': { t: 'Ideal para: negocios establecidos, profesionales independientes, empresas listas para crecer.' },
          'pro-after': { h: 'Después del lanzamiento: Mantenimiento Pro $1,500 MXN/mes, sin contrato anual → <a href="/servicios/mantenimiento/" data-href-es="/servicios/mantenimiento/" data-href-en="/en/services/web-maintenance/">ver planes</a>' },
          ...
          'premium-after': { h: 'Después del lanzamiento: Mantenimiento Pro $1,500 MXN/mes, sin contrato anual → <a href="/servicios/mantenimiento/" data-href-es="/servicios/mantenimiento/" data-href-en="/en/services/web-maintenance/">ver planes</a>' },
          'premium-cta': { t: 'Pedir cotización →' },
          'precios-condition': { h: 'Estos son nuestros precios hoy. Tomamos cinco proyectos nuevos al mes para entregar en la fecha que firmamos, y conforme se llena la agenda los ajustamos. Lo que te cotizamos se respeta.<br> <span style="color:rgba(255,255,255,.45);" id="precios-currency-note">* Aceptamos pago en USD o MXN.</span>' },
          /* ── TIENDAS EN LÍNEA */
          ...
          'tiendas-condition': { t: 'Mensualidad opcional de soporte y carga de producto desde $1,500 MXN/mes. El plan de TiendaNube (~$99–249/mes) y la comisión de la pasarela de pago (~3.8% + IVA por venta) los cubre el cliente.' },
          /* ── STAKES */
        ...
        en: {
          ...
          'precios-urgency': { t: "This quarter's pricing. We take on 5 new projects a month." },
          ...
          'launch-features': { h: '<li><strong>Basic visual identity included</strong> — logo, palette, typography</li><li>A high-impact one-page site with 4 sections (hero, services, about, contact)</li><li>Responsive design — phone and desktop</li><li>Basic SEO configured from day one</li><li><strong>Ready for AI search</strong> — schema and llms.txt so ChatGPT, Gemini and Perplexity can read you</li><li>Contact form included</li><li><strong>.com</strong> domain included the first year (or we connect yours if you already have one)</li><li>Content updates handled by Cero Studio</li>' },
          'launch-note': { t: 'Best for: restaurants, clinics, salons, local service businesses.' },
          'launch-after': { h: 'After launch: Maintenance Launch at $1,000 MXN/mo, no annual contract → <a href="/en/services/web-maintenance/" data-href-es="/servicios/mantenimiento/" data-href-en="/en/services/web-maintenance/">see plans</a>' },
          'launch-cta': { t: 'Get started →' },
          'pro-badge': { t: 'Most popular' },
          'pro-delivery': { t: 'one-time payment · delivered in 21 business days' },
          'pro-features': { h: '<li><strong>Professional identity included</strong> — logo, palette, typography + mini guidelines</li><li>4 to 6 pages, designed from scratch around your brand</li><li>You edit your content — no waiting on us</li><li>Blog included to position you as an expert</li><li>Custom animations and microinteractions</li><li>Advanced SEO + Google Search Console</li><li><strong>Optimized for AI search</strong> — schema, llms.txt and citable content on every page, so ChatGPT, Gemini and Perplexity recommend you</li><li>Google Analytics + Tag Manager setup</li><li>WhatsApp button integrated</li><li><strong>.com</strong> domain included the first year (or we connect yours if you already have one)</li><li>Responsive — phone, tablet, and desktop</li><li>Professional contact form</li>' },
          'pro-note': { t: 'Best for: established businesses, independent professionals, companies ready to grow.' },
          'pro-after': { h: 'After launch: Maintenance Pro at $1,500 MXN/mo, no annual contract → <a href="/en/services/web-maintenance/" data-href-es="/servicios/mantenimiento/" data-href-en="/en/services/web-maintenance/">see plans</a>' },
          ...
          'premium-after': { h: 'After launch: Maintenance Pro at $1,500 MXN/mo, no annual contract → <a href="/en/services/web-maintenance/" data-href-es="/servicios/mantenimiento/" data-href-en="/en/services/web-maintenance/">see plans</a>' },
          'premium-cta': { t: 'Request a quote →' },
          'precios-condition': { h: 'These are our prices today. We take on five new projects a month so every one ships on the date we sign, and as the calendar fills we adjust them. Whatever we quote you, we honor.<br><span style="color:rgba(255,255,255,.45);" id="precios-currency-note">* We accept payment in USD or MXN.</span>' },
          /* ── TIENDAS EN LÍNEA */
          ...
          'tiendas-condition': { t: 'Optional support and product-upload retainer from $1,500 MXN/month. The TiendaNube plan (~$99–249/month) and the payment gateway fee (~3.8% + tax per sale) are covered by the client.' },
          /* ── STAKES */
