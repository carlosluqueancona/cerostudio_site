    document.addEventListener('DOMContentLoaded', function () {
      ...
      var CS_I18N = {
        es: {
          ...
          'tienda-esencial-features': { h: '<li>Tienda en TiendaNube con template configurado a tu marca</li><li>Hasta 25 productos</li><li>Pasarela de pago + envíos configurados</li><li>Conexión a Instagram + botón de WhatsApp</li><li>Dominio incluido (primer año)</li>' },
          ...
          'tienda-pro-features': { h: '<li>Todo lo de Tienda Esencial</li><li>Diseño alineado a tu marca</li><li>Hasta 60 productos</li><li>SEO básico + categorías organizadas</li><li>Integraciones (Instagram Shopping)</li>' },
        ...
        en: {
          ...
          'tienda-esencial-features': { h: '<li>TiendaNube store with a template configured to your brand</li><li>Up to 25 products</li><li>Payment gateway + shipping configured</li><li>Instagram connection + WhatsApp button</li><li>Domain included (first year)</li>' },
          ...
          'tienda-pro-features': { h: '<li>Everything in Store Essential</li><li>Design aligned with your brand</li><li>Up to 60 products</li><li>Basic SEO + organized categories</li><li>Integrations (Instagram Shopping)</li>' },
